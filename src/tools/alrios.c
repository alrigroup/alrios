...
static const KnownAppInfo g_known_apps[] = {
  ...
  {"arwe", "ALRI Web Engine — Runtime e Servidor de Containers .arweb", "status, routes, ping"},
  {"arwe", "ALRI Web Engine (legado/alias)", "status, routes, ping"},
